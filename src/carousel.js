...
export class CarouselComponent extends HTMLElement {
    ...
    #setupSlides() {
        ...
        const firstClones = initialSlides.slice(0, Math.floor(this.slidesToShow)).map((el) => el.cloneNode(true));
        const lastClones = initialSlides.slice(-Math.floor(this.slidesToShow)).map((el) => el.cloneNode(true));
